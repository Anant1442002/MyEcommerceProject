...
-- Create a new user
-- -----------------------------------------------------
CREATE USER 'mobile123'@'localhost' IDENTIFIED BY 'mobilestore';

GRANT ALL PRIVILEGES ON * . * TO 'mobile123'@'localhost';

ALTER USER 'mobile123'@'localhost' IDENTIFIED WITH mysql_native_password BY 'mobilestore1';


-- -----------------------------------------------------
-- Schema mobilestore-db
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `mobilestore-db`;

CREATE SCHEMA `mobilestore-db`;

USE `mobilestore-db` ;
-- -----------------------------------------------------
-- Table `mobilestore-db`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mobilestore-db`.`product_category` (
...
-- -----------------------------------------------------
-- Table `mobilestore-db`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mobilestore-db`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
